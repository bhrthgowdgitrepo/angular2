...
testing_1.describe('testing userform-', function () {
    ...
    testing_1.xit('template', testing_1.injectAsync([testing_1.TestComponentBuilder], function (tcb) {
        return tcb.createAsync(user_form_1.UserForm).then(function (fixture) {
            var form1 = fixture.componentInstance;
        });
    }));
    testing_1.xit('testing save', testing_1.injectAsync([testing_1.TestComponentBuilder], function (tcb) {
        return tcb.createAsync(user_form_1.UserForm).then(function (fixture) {
            var form1 = fixture.componentInstance;
            form1.save();
    ...
    testing_1.xit('testing drawcheckboxes', testing_1.injectAsync([testing_1.TestComponentBuilder], function (tcb) {
        return tcb.createAsync(user_form_1.UserForm).then(function (fixture) {
            var form1 = fixture.componentInstance;
            var input = {
                target: {
...
//# sourceMappingURL=user-form.spec.js.map