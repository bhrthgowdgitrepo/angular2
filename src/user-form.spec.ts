...
describe('testing userform-',
    function() {
        ...
        it('testing delete', injectAsync([TestComponentBuilder], function(tcb) {
          ...
          xit('template', injectAsync([TestComponentBuilder], function(tcb) {
            return tcb.createAsync(UserForm).then(function(fixture) {
                let form1: UserForm = fixture.componentInstance;
               
            })
        }));
         xit('testing save', injectAsync([TestComponentBuilder], function(tcb) {
            return tcb.createAsync(UserForm).then(function(fixture) {
                let form1: UserForm = fixture.componentInstance;
                form1.save();
         ...
         xit('testing drawcheckboxes', injectAsync([TestComponentBuilder], function(tcb) {
            return tcb.createAsync(UserForm).then(function(fixture) {
                let form1: UserForm = fixture.componentInstance;
                let input = {
                    target:{
